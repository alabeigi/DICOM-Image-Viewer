...
WindowLevelIcon.displayName = "WindowLevelIcon";

const InvertIcon = memo(() => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
InvertIcon.displayName = "InvertIcon";
